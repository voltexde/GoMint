...
public class Client {
    ...
    public Client( ScheduledExecutorService scheduledExecutorService, PostProcessExecutor postProcessExecutor, Consumer<Pair<Integer, Integer>> chunkPairConsumer ) {
        ...
        try {
            ...
            this.socket.setProtocolVersion( 8 );
