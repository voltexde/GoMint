...
import io.gomint.server.enchant.EnchantmentRespiration;
 ...
 * @version 1.0
 */
public class EnchantmentRespirationGenerator implements EnchantmentGenerator {

    @Override
    public Enchantment generate( short level ) {
        return new EnchantmentRespiration( level );
    }
