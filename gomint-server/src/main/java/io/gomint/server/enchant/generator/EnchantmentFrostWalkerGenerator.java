...
import io.gomint.server.enchant.EnchantmentFrostWalker;

/**
 * @author geNAZt
 * @version 1.0
 */
public class EnchantmentFrostWalkerGenerator implements EnchantmentGenerator {

    @Override
    public Enchantment generate( short level ) {
        return new EnchantmentFrostWalker( level );
    }
