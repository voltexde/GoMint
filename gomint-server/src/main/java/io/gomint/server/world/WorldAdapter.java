...
public abstract class WorldAdapter implements World {
	...
	/**
	 * Gets a random instance which may be used by any object that is managed by the world.
	 *
	...
	public Block getBlockAt( Vector vector ) {
		return this.getBlockAt( (int) vector.getX(), (int) vector.getY(), (int) vector.getZ() );
	}

	public Block getBlockAt( int x, int y, int z ) {
		return new GenericBlockAdapter( this, x, y, z );
	}
