...
public class DispenserConverter extends BasisConverter<DispenserTileEntity> {
    ...
    public DispenserConverter( ApplicationContext context, Object2IntMap<String> itemConverter ) {
        super( context, itemConverter );
    }

    @Override
    public DispenserTileEntity readFrom( NBTTagCompound compound ) {
        DispenserTileEntity tileEntity = new DispenserTileEntity( getBlock( compound ) );
